...
- Harden `HashRoutedApp`, `PublicHashRoutedApp`, and `LinkRoutedApp` as the first reusable app runtime recipes: SPA route rendering for hash routes, and native-link/MPA chrome plus metadata synchronization for normal links.
